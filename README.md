...
![workflow](https://github.com/QinglinFeng/hri_final_project/actions/workflows/ci.yml/badge.svg)
...
### Set Up the Code
2. **Clone this repository** and give it the name of your repo: `git clone git@github.com:QinglinFeng/hri_final_project.git <NAME>`. You now have a directory called NAME. **Enter** it: `cd <NAME>`.
